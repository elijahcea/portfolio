    ...
    <>
      <nav className="md:hidden">
        <button
          ...
          className="p-2 relative cursor-pointer transition-opacity ease-in-out duration-250 text-foreground hover:opacity-60 align-middle"
        >
                        ...
                        <ul className="flex flex-col gap-4">
                          {links.map((i) => (
                            <Link key={i.title} href={i.href}>
                              <li
                                onClick={() => setIsOpen(false)}
                                className="py-2 px-3 rounded transition-colors hover:bg-foreground/10 duration-250"
                              >
                                {i.title}
                              </li>
                            </Link>
